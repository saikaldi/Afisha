...
SECRET_KEY = 'django-insecure-^t0$k5b#@n)93@6&z7yqy4wgzzogrt4p!33ots+0#9l9214+f5'
...
#
# # SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = 'django-insecure-ba4rvy_w_k1p)pona+5&5jhhttcb!+4eikt7jwb=yq)ie=x37f'
#
# # SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True
#
